export default {
  ...
  data: {
    ...
    list: [
      'Inventory data (for example name).',
  ...
  contact: {
    title: 'Contact',
    text: 'When contacting us (e.g. via contact form, e-mail, telephone or social media), the user\'s details are processed for processing the contact enquiry and its processing in accordance with Art. 6 para. 1 lit. b) GDPR. User information can be stored in a customer relationship management system ("CRM system") or comparable request organization.'
  },
  gravatar: {
    title: 'Retrieval of profile pictures from Gravatar',
    text: [
      'We use the service Gravatar of Automattic Inc, 60 29th Street #343, San Francisco, CA 94110, USA.',
